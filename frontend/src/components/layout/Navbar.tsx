          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <div className="relative group pt-4 pb-4">
              ...
              <div className="absolute top-12 left-0 mt-2 w-48 bg-white border border-slate-100 shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 flex flex-col overflow-hidden">
                <Link href="/peminatan" className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                  Peminatan / Jurusan
                </Link>
                <Link href="/guru" className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                  Direktori Guru
                </Link>
              </div>
            </div>
            ...
            <div className="relative group pt-4 pb-4">
              ...
              <div className="absolute top-12 left-0 mt-2 w-48 bg-white border border-slate-100 shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 flex flex-col overflow-hidden">
                <Link href="/ekstrakurikuler" className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                  Ekstrakurikuler
                </Link>
                <Link href="/prestasi" className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                  Prestasi
                </Link>
                <Link href="/karya" className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                  Karya Siswa
                </Link>
              </div>
            </div>
            ...
            <Link href="/ppdb" className="text-sm font-bold px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-md shrink-0">
              PPDB Online
            </Link>
          </div>
        </div>
