    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Tambah Berita Baru</h1>
            <p className="text-xs text-slate-500 mt-0.5">Tulis dan publikasikan informasi kegiatan resmi sekolah.</p>
          </div>
        </div>
