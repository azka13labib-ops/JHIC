...
export default function CreateStudentWorkPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/student-works`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">Tambah Karya Siswa</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={loading}>
            {loading ? "Menyimpan..." : "Simpan Karya Siswa"}
          </Button>
        </form>
      </div>
    </div>
