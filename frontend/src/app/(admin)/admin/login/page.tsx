...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-100 p-4 sm:p-6 lg:p-8 font-sans relative overflow-hidden">
      ...
      <div className={`w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-200/90 overflow-hidden grid grid-cols-1 md:grid-cols-2 relative z-10 transition-all duration-300 ${
        isShaking ? 'animate-shake ring-4 ring-rose-500/30' : ''
      }`}>
        ...
        <div className="relative hidden md:flex flex-col justify-between p-8 lg:p-10 bg-slate-950 text-white min-h-[540px] overflow-hidden group">
          ...
          <div className="relative z-10 flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-white/95 p-1.5 flex items-center justify-center shadow-lg border border-white/40 shrink-0">
              <Image
          ...
          <div className="relative z-10 space-y-2.5">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-blue-300 text-[10px] font-bold uppercase tracking-wider backdrop-blur-md">
        ...
        {/* Right Half: Form */}
        <div className="p-8 sm:p-10 lg:p-12 flex flex-col justify-between bg-white text-slate-900">
          
          {/* Mobile Top Crest */}
          <div className="flex items-center gap-3 md:hidden mb-6">
            <div className="w-11 h-11 rounded-xl bg-slate-50 border border-slate-200 p-1.5 flex items-center justify-center shadow-sm">
              <Image
                src="/logo-sekolah.jpg"
                alt="Logo SMA PGRI 1"
                width={32}
            ...
            <div>
              <h2 className="font-bold text-sm text-slate-900">SMA PGRI 1 Lumajang</h2>
              <span className="text-[10px] text-slate-500 font-semibold uppercase tracking-wider">Portal Admin</span>
            </div>
          </div>
