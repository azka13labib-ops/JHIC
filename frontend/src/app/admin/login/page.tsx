  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        const isSubdomain = window.location.hostname.startsWith('cp.');
        window.location.href = isSubdomain ? '/dashboard' : '/admin/dashboard';
      } else {
      ...
      <div className={`w-full min-h-screen grid grid-cols-1 md:grid-cols-2 relative z-10 transition-all duration-300 ${
        ...
        <div className="relative hidden md:flex flex-col justify-between p-8 lg:p-14 bg-slate-950 text-white min-h-screen overflow-hidden group">
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white/95 p-1.5 flex items-center justify-center shadow-lg border border-white/40 shrink-0 overflow-hidden">
              <Image
        ...
        <div className="flex items-center justify-center p-6 sm:p-12 lg:p-16 min-h-screen relative">
          ...
          <div className="w-full max-w-md flex flex-col justify-between min-h-[500px]">
            ...
            <div className="flex items-center gap-3 md:hidden mb-8">
              <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 p-1.5 flex items-center justify-center shadow-sm overflow-hidden">
                <Image
                  src="/logo-sekolah.png"
                  alt="Logo SMA PGRI 1"
                  width={36}
