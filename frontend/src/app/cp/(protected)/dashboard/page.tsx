...
export default function DashboardPage() {
  ...
  const quickActions = [
    { label: 'Tulis Berita Baru', href: '/news/create', icon: Newspaper, color: 'bg-blue-50 text-blue-600 hover:bg-blue-100 border-blue-200' },
    { label: 'Tambah Agenda', href: '/agendas/create', icon: Calendar, color: 'bg-indigo-50 text-indigo-600 hover:bg-indigo-100 border-indigo-200' },
    { label: 'Input Prestasi', href: '/achievements/new', icon: Trophy, color: 'bg-amber-50 text-amber-600 hover:bg-amber-100 border-amber-200' },
    { label: 'Upload Karya Siswa', href: '/student-works/create', icon: PenTool, color: 'bg-purple-50 text-purple-600 hover:bg-purple-100 border-purple-200' },
    { label: 'Tambah Galeri Foto', href: '/galleries/create', icon: ImageIcon, color: 'bg-rose-50 text-rose-600 hover:bg-rose-100 border-rose-200' },
    { label: 'Tambah Artikel', href: '/articles/create', icon: BookOpen, color: 'bg-emerald-50 text-emerald-600 hover:bg-emerald-100 border-emerald-200' },
  ];
