...
export const metadata: Metadata = {
  title: 'Tracer Study Alumni | SMA PGRI 1 Lumajang',
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <section className="bg-linear-to-b from-slate-50 via-white to-slate-50 text-slate-900 border-b border-slate-200 py-16 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3 tracking-tight">Tracer Study Alumni</h1>
          <p className="text-slate-600 max-w-xl mx-auto text-base">Jejak langkah alumni di perguruan tinggi dan dunia profesional</p>
        </div>
      </section>
