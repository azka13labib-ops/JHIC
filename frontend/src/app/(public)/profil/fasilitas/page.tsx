...
export default function FasilitasPage() {
  const facilities = [
    ...
    {
      icon: Tv,
      title: 'Smart Classroom & Gedung Pertemuan',
      specs: ['Smart Board & Laser Projector', 'Gedung Aula Kapasitas 500 Orang', 'Stage & Sound System Seminar', 'Koneksi Wi-Fi Dedicated'],
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-2xl">
            ...
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Infrastruktur terintegrasi yang mendukung pembelajaran digital, riset sains, kreativitas seni, dan kebugaran fisik peserta didik SMAGRISA.
            </p>
          </div>
        </div>
      </section>
