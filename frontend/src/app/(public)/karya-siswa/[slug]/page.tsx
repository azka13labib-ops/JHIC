    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 py-8 sm:py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <span>Kembali ke Karya Siswa</span>
        </Link>

        {/* Article Box */}
        <article className="bg-white border border-slate-200 rounded-xl p-6 sm:p-10 shadow-2xs">
          
          <h1 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-normal text-slate-900 leading-tight mb-3">
            {item.title}
          </h1>

          <div className="flex items-center gap-1.5 text-xs font-semibold text-blue-700 pb-5 mb-6 border-b border-slate-100">
            <User className="w-3.5 h-3.5 text-slate-400" />
            <span>Karya Kreatif oleh: {item.student_name}</span>
          </div>
