...
export const metadata: Metadata = {
  title: 'Artikel | SMA PGRI 1 Lumajang',
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <section className="bg-linear-to-br from-[#1E2B58] to-[#2B3B6F] text-white py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-blue-200">Kumpulan tulisan inspiratif dari siswa dan guru</p>
        </div>
      </section>
      ...
      <div className="flex-1 flex items-center justify-center p-4 py-20">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl text-center max-w-2xl w-full border border-slate-100">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-4">Belum Ada Artikel</h2>
          <p className="text-slate-600 text-lg mb-8 leading-relaxed">
            Halaman ini nantinya akan berisi tulisan-tulisan karya warga sekolah. Saat ini sistem masih dalam pengembangan.
          </p>
