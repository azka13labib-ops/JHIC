    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/jurusan" className="text-blue-600 underline">← Kembali ke Peminatan</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            <h2 className="text-xl font-bold text-slate-900 mb-4">📋 Mata Pelajaran</h2>
          ...
          <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
            <h2 className="text-xl font-bold text-slate-900 mb-4">🚀 Prospek Karir</h2>
            <ul className="space-y-2">
          ...
          <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100">
            <h2 className="text-xl font-bold text-slate-900 mb-4">🏆 Kegiatan Unggulan</h2>
            <ul className="space-y-2">
        ...
        <div className="mt-12 text-center">
          ...
          >
            Daftar Sekarang via PPDB Online →
          </Link>
        </div>
      </div>
    </div>
