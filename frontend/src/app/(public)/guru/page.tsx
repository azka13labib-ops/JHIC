    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <section className="bg-linear-to-br from-[#1E2B58] to-[#2B3B6F] text-white py-16 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Direktori Guru & Staf</h1>
          <p className="text-blue-200">Mengenal lebih dekat para pendidik pahlawan tanpa tanda jasa</p>
        </div>
      </section>
