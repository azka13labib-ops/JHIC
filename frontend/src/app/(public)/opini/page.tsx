        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-2xl">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl font-normal text-slate-900 tracking-tight">
              Opini & Kolom Pemikiran
            </h1>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Kumpulan pandangan kritis, esai edukasi, dan refleksi pemikiran guru serta pemerhati pendidikan SMAGRISA.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 max-w-6xl">
        {opinions.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-xl p-12 text-center max-w-md mx-auto shadow-2xs">
            ...
            <h3 className="text-sm font-bold text-slate-900">Belum Ada Opini</h3>
            <p className="text-xs text-slate-500 mt-1">Tulisan opini terbaru akan segera dipublikasikan di sini.</p>
          </div>
        ) : (
                  ...
                  <div>
                    ...
                    <div className="p-4 space-y-2">
                      <div className="flex items-center justify-between text-[11px] text-slate-500">
                        ...
                        <span className="text-blue-700 font-semibold">{item.author || 'Pendidik SMAGRISA'}</span>
                      </div>
